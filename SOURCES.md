...
- `public/paina-social-card-a0b27d26.png` — the canonical cache-busting 1200×630 social-preview image. It is a deterministic diagonal composition with the oversized contiguous “Mochi.Poke.Pā‘ina.” strike spanning the lower frame edge-to-edge, “Mochi” set in the owner-supplied Pā‘ina purple swatch `#A898CF`, and “Pā‘ina.” colored from the official logo palette. The left crop uses Paina's finished mochi plate from `https://doordash-static.s3-us-west-2.amazonaws.com/media/photosV2/ed2a4739-c2e1-4a53-bb0c-19f3a47c20c5-retina-large.png`; the right side uses Paina's overhead bowl spread from `https://doordash-static.s3-us-west-2.amazonaws.com/media/store/header/cb8d4c56-9bfa-4a15-b17c-9e787fba0307.jpg` and carries the official logo. It retains the bundled Bricolage Grotesque face, with no generative redraw of the food or logo. SHA-256: `A0B27D26D42DF725F9629818DC181ADAC7AF991B10AEEE6C7AECBBD6245BA952`.
- `public/paina-social-card-113effa5.png`, `public/paina-social-card-748720b7.png`, `public/paina-social-card-v2.png`, `public/paina-social-card.png`, and `public/og.png` — legacy preview aliases preserved for previously shared or convention-based URLs. Each file is byte-identical to the canonical image above, so every supported preview path returns the same approved swatch-matched thumbnail and no alternate artwork remains public.
